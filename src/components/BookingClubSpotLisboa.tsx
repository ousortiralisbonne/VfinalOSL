// src/components/BookingClubSpotLisboa.tsx
          ...
          {showSuccess ? (
            ...
            <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    {t("bookingModal.form.reservationType")}
                  </label>
                  <input
                    type="text"
                    ...
                    onChange={handleChange}
                    placeholder={t(
                      "bookingModal.form.reservationTypePlaceholder"
                    )}
                    className="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-[#37b7ab] focus:border-[#37b7ab] transition"
                  />
                </div>
...
export default BookingClubSpotLisboa;
