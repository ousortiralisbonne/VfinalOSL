// src/components/BookingclubLuxFragil.tsx
...
const BookingclubLuxFragil = ({
  ...
  const handleChange = (
    ...
    // If the input is a date, format it to DD/MM/YYYY
    if (name === "date" && value) {
        ...
        <div className="p-6">
          {showSuccess ? (
            ...
            <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder={t("bookingModal.form.entryTypePlaceholder")}
                    className="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-[#37b7ab] focus:border-[#37b7ab] transition"
                  />
                </div>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  {t("bookingModal.form.musicPreferences")}
                </label>
                <input
                  type="text"
...
export default BookingclubLuxFragil;
